...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex overflow-hidden bg-white">
      ...
      {/* ── LEFT — Dark panel slides in from LEFT ── */}
      <motion.div
      ...
      >
        ...
        {/* Glow blobs */}
        <div className="absolute top-10 left-10 w-72 h-72 bg-[#4ade80] rounded-full opacity-10 blur-3xl pointer-events-none" />
        <div className="absolute bottom-10 right-10 w-56 h-56 bg-[#4ade80] rounded-full opacity-10 blur-3xl pointer-events-none" />
        ...
        <div className="relative z-10 w-full max-w-xs mx-auto float-anim">
          ...
          {/* Floating badges — mirrored for left panel */}
          <div className="absolute -right-8 top-1/4 bg-white rounded-xl px-3 py-2 shadow-xl flex items-center gap-2">
            <span className="w-2 h-2 bg-[#4ade80] rounded-full animate-pulse" />
            <span className="text-xs font-semibold text-gray-800 whitespace-nowrap">Live Preview</span>
          </div>
          <div className="absolute -left-6 bottom-10 bg-[#4ade80] rounded-xl px-3 py-2 shadow-xl">
            <span className="text-black text-xs font-bold whitespace-nowrap">3 Templates ✨</span>
          </div>
          <div className="absolute -left-4 top-0 bg-[#1a1f2e] border border-white/10 rounded-xl px-3 py-2 shadow-xl">
        ...
        <div className="relative z-10 text-center mt-12">
          <p className="font-display text-2xl font-black text-white mb-2">Build. Customize. Download.</p>
          <p className="text-white/40 text-sm max-w-xs mx-auto mb-8">
            Create professional resumes with live preview and one-click PDF export.
          </p>
          <div className="text-left space-y-3 max-w-xs mx-auto">
            {["Live preview as you type","3 professional templates","One-click PDF export","Manage multiple resumes","100% free forever"].map(f => (
      ...
      {/* ── RIGHT — Form Panel (fades up on mount) ── */}
      <motion.div
      ...
      >
        <div className="max-w-sm w-full mx-auto lg:mx-0">
          ...
          <h1 className="font-display text-4xl font-black text-gray-900 mb-1">Create account</h1>
          <p className="text-gray-400 text-sm mb-8">Start building your resume today — it's free</p>
