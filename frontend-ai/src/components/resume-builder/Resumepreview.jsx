...
// 1. Create  src/components/resume-builder/templates/YourTemplate.jsx
// 2. Import it below
// 3. Add one line to the TEMPLATES map
...
// import FutureTemplate    from "./templates/FutureTemplate";  ← add here
...
const TEMPLATES = {
  ...
  minimal:      MinimalTemplate,
  professional: ProfessionalTemplate,
  // future:    FutureTemplate,  ← add here
};
