...
// //   const progress   = Math.round(((activeIdx + 1) / TABS.length) * 100);
...
// //           </span>
// //           <span className="text-xs font-bold text-green-600">{progress}% complete</span>
// //         </div>
...
// //         {/* Card header */}
// //         <div className="px-5 py-3.5 border-b border-gray-100 bg-gray-50 flex items-center gap-2.5">
...
// //             <p className="text-xs text-gray-400 mt-0.5">Fill in your {active.label.toLowerCase()} details</p>
// //           </div>
// //           {/* Step dots */}
...
// //                 : "bg-green-500 hover:bg-green-600 text-white shadow-sm hover:-translate-y-0.5"
// //             }`}
// //           >
...
// //           <span className="text-xs text-gray-400">{activeIdx + 1} / {TABS.length}</span>
...
//     ),
//     summary: pct(
//       [summary, links.github, links.linkedin, links.leetcode].filter(has).length,
//       4
//     ),
//     skills: pct(
//       Object.values(skills).filter((arr) => arr.length > 0).length,
//       4
//     ),
...
//   // Current section's fill %
//   const sectionPct = sections[active.id];

//   return (
//     <div className="flex flex-col gap-4">

//       {/* ── Progress bar — based on actual data filled ── */}
//       <div>
//         <div className="flex items-center justify-between mb-1.5">
//           <span className="text-xs font-semibold text-gray-500 uppercase tracking-wide">
//             Overall Progress
//           </span>
//           <span className={`text-xs font-bold ${overall === 100 ? "text-green-600" : overall >= 50 ? "text-yellow-500" : "text-gray-400"}`}>
//             {overall}% filled
//           </span>
//         </div>
//         <div className="w-full h-1.5 bg-gray-200 rounded-full overflow-hidden">
...
//               overall === 100 ? "bg-green-500" : overall >= 50 ? "bg-yellow-400" : "bg-green-500"
//             }`}
//             style={{ width: `${overall}%` }}
//           />
//         </div>
...
//         {TABS.map((tab, idx) => {
//           const isActive  = idx === activeIdx;
//           const tabPct    = sections[tab.id];
//           const isComplete = tabPct === 100;
//           return (
//             <button
//               key={tab.id}
//               onClick={() => setActiveIdx(idx)}
